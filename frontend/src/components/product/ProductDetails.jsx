    ...
    return (
        ...
        {loading ? <Loader /> : 
            <Fragment>
                ...
                <div className='flex flex-row  flex-wrap '>
                    ...
                    <div className='mx-3 ml-0 border flex flex-row  border-black rounded w-fit '>
                        <button className="flex-none px-3 py-1 rounded-sm  hover:shadow-black " onClick={()=>setQuantity(quantity-1)}>-</button>
                            <input type="text" name="qty" value={quantity} className="flex-none w-12 p-1  text-center bg-gray-100 outline-none"/>
                ...
                {/* Reviews Scetion */}
                <div className=" border-black border-t-2 border-b-2 rounded-lg  m-3">
